...
- Name: fullstack.spec.js >> Fullstack: reservations approval >> admin approves a seeded reservation and sees state change
- Location: tests/e2e/fullstack.spec.js:129:3

# Error details

```
Error: apiRequestContext.post: connect ECONNREFUSED 172.22.0.4:3000
Call log:
