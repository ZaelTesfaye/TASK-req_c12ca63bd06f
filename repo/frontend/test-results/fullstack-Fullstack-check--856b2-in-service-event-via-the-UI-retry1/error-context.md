...
- Name: fullstack.spec.js >> Fullstack: check-in flow >> admin checks in an attendee at a seeded in_service event via the UI
- Location: tests/e2e/fullstack.spec.js:276:3
