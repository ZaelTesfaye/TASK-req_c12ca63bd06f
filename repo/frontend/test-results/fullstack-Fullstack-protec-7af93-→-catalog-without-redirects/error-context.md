...
- Name: fullstack.spec.js >> Fullstack: protected-route navigation >> admin navigates events → reservations → catalog without redirects
- Location: tests/e2e/fullstack.spec.js:351:3

# Error details

```
Error: apiRequestContext.post: getaddrinfo EAI_AGAIN backend
Call log:
